...
echo '================================================='
echo '======== KITTI depth dataset downloader =========' 
echo '================================================='
echo ''
echo '         {'
echo '      {   }'
